...
## Table of Contents
  - [Anime.js](#animejs)
  - [Integrating with Svelte](#integrating-with-svelte)
    - [$effect](#effect)
...
There's more that can be done that I haven't explored yet, you can probably compose with Anime.js timelines in powerful ways.
