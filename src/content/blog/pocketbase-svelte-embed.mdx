...
<div class="my-4">
  <Alert
    type="info"
    message="In many cases you'll want to serve static files from a CDN or reverse proxy for better performance. This setup is for applications where the convenience of a single binary outweighs those concerns."
  />
</div>
